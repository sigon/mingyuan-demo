...
//                    alert(_this.opts.activeIndex);
//                        alert(index == _this.opts.activeIndex);
                        if(index == _this.opts.activeIndex){
...
//                                alert(this.innerHTML);
                                var url = "taskLogVo.taskId="+$("#taskId").val()+"&taskLogVo.curDate="+this.innerHTML+"&queryint=1&taskLogVo.taskType"+$("#taskType");
//                                $(this).bind(_this.opts.eventType,function(){});
                                window.location.href="/songtasklog_queryTaskLog.action?"+url;
                            });
                        }
					});
			}
